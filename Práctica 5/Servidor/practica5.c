...
///////////////////////////////////////////////////////////////////////////////
	...
	}else
	{
		...
		printf("SOF = %X", buffer[0]);
		printf("SENSOR = %X", buffer[1]);
		printf("DATA_SIZE= %X", buffer[2]);
		printf("REGISTRO: %X", buffer[3]);
		printf("CS = %X", buffer[4]);
	}
	...
	send(new_socket, Buffer_server, strlen(Buffer_server),0);
///////////////////////////////////////////////////////////////////////////////
}
