...
///////////////////Control del LED
	...
	wiringPiI2CWriteReg16(dir, PD_LED_SELECT, 0x0500);//LED 1 en intervalo A y B
	wiringPiI2CWriteReg16(dir, ILED1_COARSE,0x3630);
	wiringPiI2CWriteReg16(dir, ILED3_COARSE,0x0000);
	wiringPiI2CWriteReg16(dir, ILED2_COARSE,0x0000); 
	//wiringPiI2CWriteReg16(dir, ILED_FINE,0x1903);
	wiringPiI2CWriteReg16(dir, SLOTA_LED_PULSE,0x1907);//0319
	wiringPiI2CWriteReg16(dir, SLOTB_LED_PULSE,0x1907);
